...
import { AnimalQuiz, type QuizAnimal } from "@/components/visitor/AnimalQuiz";
...
export default async function QuizPage() {
  ...
  return (
    <div className="pb-20 md:pb-0">
      <Navbar />
      <PageHeader icon={Brain} eyebrow={t.extra.quizEyebrow} title={t.extra.quizTitle} subtitle={t.extra.quizSubtitle} />
      <main className="mx-auto max-w-4xl px-4 md:px-6">
        <AnimalQuiz animals={quizAnimals} />
      </main>
      <SiteFooter />
      <BottomNav />
    </div>
